...
def classify_images(images_dir, results_dic, model):
    ...
    """
    # process all files in the results_dic by using images_dir fullpath, indicating
    # the folder and the filename (key)
    for key in results_dic:
        ...
        # results_dic as an exact match(1)
    ...
    # for key in results_dic:
    #     print("\nFilename=", key, "\npet_image Label=", results_dic[key])
